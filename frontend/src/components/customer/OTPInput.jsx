...
/**
 * 6-box OTP input. Auto-advances on digit, auto-submits on 6th, supports
 * paste-fills-all-six. iOS will surface the WhatsApp code in the keyboard
      ...
      {Array.from({ length }).map((_, i) => (
        <input
          ...
          className="w-12 h-14 text-center text-2xl font-semibold rounded-xl
                     bg-[color:var(--c-offwhite)] border border-[color:var(--c-slate-line)]
                     focus:outline-none focus:border-[color:var(--c-charcoal)]
                     focus:border-2 transition-colors disabled:opacity-60 tabular"
